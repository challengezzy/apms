...
private Logger logger = NovaLogger.getLogger(this.getClass());
	...
	public int computeA04Data(String acnum) throws Exception {
		...
		qrySb.append(",(SELECT ENGMODEL FROM V_ENG_INFOHIS V WHERE V.ENGSN ='V'||SUBSTR(L.ESN_1,2) AND V.STIME <= L.RPTDATE+1 AND V.ETIME >= L.RPTDATE-1 AND ROWNUM =1 ) ENGMODEL_1");
		qrySb.append(",(SELECT ENGMODEL FROM V_ENG_INFOHIS V WHERE V.ENGSN ='V'||SUBSTR(L.ESN_2,2) AND V.STIME <= L.RPTDATE+1 AND V.ETIME >= L.RPTDATE-1 AND ROWNUM =1 ) ENGMODEL_2");
