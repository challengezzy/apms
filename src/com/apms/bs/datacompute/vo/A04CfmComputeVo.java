...
public class A04CfmComputeVo extends DfdComputedVo {
	...
	public void insertToTable() throws Exception{
		...
		StringBuilder sb = new StringBuilder("INSERT INTO A_DFD_A04CFM56_COMPUTE(");
		...
		logger.debug("插入A04Cfm ["+msgno+"] 报文计算数据！");
	}
