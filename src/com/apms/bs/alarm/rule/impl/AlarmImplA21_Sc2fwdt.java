...
/**
 * A21号空调前客舱预选和区域差值飘点告警
 */
public class AlarmImplA21_Sc2fwdt extends AlarmRuleImplBaseClass{
	@Override
	public void alartTrigger(AlarmRuleVo ruleVo, AlarmMonitorTargetVo targetVo) throws Exception{
		...
		int v_pointtype= a21comVo.getFieldVo_sc2fwdt().getV_pointtype().intValue();
