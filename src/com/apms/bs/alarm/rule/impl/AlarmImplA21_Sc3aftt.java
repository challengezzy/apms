...
/**
 * A21号空调后客舱预选和区域差值飘点告警
 */
public class AlarmImplA21_Sc3aftt extends AlarmRuleImplBaseClass{
	@Override
	public void alartTrigger(AlarmRuleVo ruleVo, AlarmMonitorTargetVo targetVo) throws Exception{
		...
		int v_pointtype= a21comVo.getFieldVo_sc3aftt().getV_pointtype().intValue();
