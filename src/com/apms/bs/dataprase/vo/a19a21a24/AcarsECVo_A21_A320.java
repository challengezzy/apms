...
public class AcarsECVo_A21_A320 extends AcarsLineDataVo{
	...
	public AcarsECVo_A21_A320(String str) throws Exception{
		originalStr = str;
		...
		lim = ReportParseUtil.strToFloat(columns[6], "lim");
