...
public class AcarsECVo_A02_A320_IAE extends AcarsLineDataVo{
	...
	public AcarsECVo_A02_A320_IAE(String str) throws Exception{
		originalStr = str;
		...
		qa=  ReportParseUtil.getNumberStr(columns[4]);
		qe = ReportParseUtil.getNumberStr(columns[5]);
