...
public class AcarsEC_EEVo_A06_A320_CFM extends AcarsLineDataVo{
	...
	public AcarsEC_EEVo_A06_A320_CFM(String str) throws Exception{
		originalStr = str;
		...
		tr = ReportParseUtil.getNumberStr(columns[5]);
	}
