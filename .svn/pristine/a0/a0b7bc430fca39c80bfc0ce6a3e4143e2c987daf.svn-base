...
public class R13DataParseImpl_A340 extends ApuDataParseImpl{
	...
	public void praseDataToVo(String gStr,String transdate) throws Exception{
		...
		AcarsE1Vo_R13_A330_A340 e1 = new AcarsE1Vo_R13_A330_A340(lines[7],modelSeires);
		r13vo.setE1(e1);
		...
		r13vo.setN1(new AcarsNxVo_R13_A330_A340(lines[8],modelSeires));
		r13vo.setN2(new AcarsNxVo_R13_A330_A340(lines[9],modelSeires));
		r13vo.setN3(new AcarsNxVo_R13_A330_A340(lines[10],modelSeires));
		r13vo.setV1(new AcarsV1Vo_R13_A330_A340(lines[11],modelSeires));
	...
	synchronized public void insertParseData() throws Exception{
		...
		logger.info("R13报文[msg_no]=["+msgno+"]入库成功！");
