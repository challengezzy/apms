package com.apms.flex.modules.engine.listeners
{
	...
	public class A05TelegraphViewIAEListener implements ListButtonListener
	{
		...
		public function A05TelegraphViewIAEListener()
		{
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			var sqla05C:String = "SELECT * FROM V_A05ILIST_VIEW WHERE MSG_NO='"+msgno+"'";
			formService.getSimpleHashVoArrayByDS(ApmsUIConst.DATASOURCE_APMS,sqla05C);
		...
		private function geta05ListHashVoHandler(event:ResultEvent):void{
			...
			a05iViewWindow = new A05ITelegraphViewWindow();
			a05iViewWindow.a05ivo = a05vo;
			
			PopUpManager.addPopUp(a05iViewWindow,desktop,true);
			PopUpManager.centerPopUp(a05iViewWindow);
		}
