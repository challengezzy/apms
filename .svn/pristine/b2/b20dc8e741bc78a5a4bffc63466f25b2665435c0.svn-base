...
public class AcarsN1N2Vo_A01A02_A320_IAE extends AcarsLineDataVo{
	...
	public AcarsN1N2Vo_A01A02_A320_IAE(String str) throws Exception{
		originalStr = str;
		...
		checkFieldsNum(originalStr,columns, 7);
			...
			n1 = ReportParseUtil.strToStrWithIntPostion(columns[3], 3);
			n2 = ReportParseUtil.strToStrWithIntPostion(columns[4], 3);
			ff = ReportParseUtil.getNumberStr(columns[5]);
			p125 = ReportParseUtil.strToStrWithIntPostion(columns[6], 2);
	}
