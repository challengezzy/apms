...
public class AcarsT1T2Vo_A01A02_A320_IAE extends AcarsLineDataVo{
	...
	public AcarsT1T2Vo_A01A02_A320_IAE(String str) throws Exception{
		originalStr = str;
		...
		t2 = ReportParseUtil.strToStrWithIntPostion(columns[7], 3);
	}
