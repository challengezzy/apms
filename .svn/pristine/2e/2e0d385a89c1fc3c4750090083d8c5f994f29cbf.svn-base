 ...
 * @date Dec 16, 2014
 */
public class AlarmImplA21_ExtendLimit extends AlarmRuleImplBaseClass{
	...
	public void alartTrigger(AlarmRuleVo ruleVo, AlarmMonitorTargetVo targetVo) throws Exception{
		...
		int excount = a21comVo.getEx_count();
		String modelSeries = a21comVo.getModelSeries();
		...
		if(excount >= 3){
			...
			String time=DateUtil.getDateStr(a21comVo.getDate_utc(),"yyMMdd HH:mm");
			...
			sb.append(",L.PB_WAI_W1,L.PB_PRV1_W1,L.PB_PRV2_W1,L.SW_XFR_W1  ");
			sb.append(",L.PIN_HPV_M1,L.PIN_PRV_M1,L.OPV1_M1,L.PIN_HPV_M2,L.PIN_PRV_M2,L.OPV2_M1");
			sb.append(",L.FAV1_Z1,L.FAV2_Z1,L.HPV1_Z1,L.HPV2_Z1,L.PRV1_Z1,L.PRV2_Z1  ");
			sb.append(",L.FAV1_R1,L.FAV2_R1,L.HPV1_R1,L.HPV2_R1,L.PRV1_R1,L.PRV2_R1  ");
			sb.append(",L.PDMT_L_D1,L.PDMT_R_D1,L.CKT_F1,L.FWDT_F1,L.AFTT_F1  " );
			sb.append(",L.OVP_X1,L.TPO_S1,L.TPO_T1");
			...
			//sb.append(",s.ex_ovp,s.ex_tpo1,s.ex_tpo2");
			sb.append(",s.ex_div_ck,s.ex_div_fwd,s.ex_div_aft,s.update_date ");
			sb.append("from a_dfd_a21_compute_stat s,a_dfd_a21_list L  where L.msg_no = s.msg_no ");
			sb.append(" and L.msg_no = ?");
			
			HashVO[] vos = dmo.getHashVoArrayByDS(ApmsConst.DS_APMS, sb.toString(), a21comVo.getMsgno());
			
			//生成Detail字段
			StringBuilder detailSb = new StringBuilder();
			String pf_lower = "0.45";
			String pf_upper = "0.7";
			String cot_lower = "110";
			String cot_upper = "200";
			String pbv_lower = "20";
			String pbv_upper = "60";
			...
			detailSb.append( getMsgDetail1(vos[0], "RI1", "EX_RI1", "RI_E1", "30", "5") );
			detailSb.append( getMsgDetail1(vos[0], "TW1", "EX_TW1", "TW_S1", "42", "4") );
			detailSb.append( getMsgDetail1(vos[0], "TP1", "EX_TP1", "TP_S1", "40", "-20") );
			detailSb.append( getMsgDetail1(vos[0], "PDMT1", "EX_D11", "PDMT_L_D1", "30", "4") );
			detailSb.append( getMsgDetail1(vos[0], "PRV1", "EX_PRV1", "PIN_PRV_M1", "70", "37") );
			...
			detailSb.append( getMsgDetail1(vos[0], "RI2", "EX_RI2", "RI_N1", "30", "5") );
			detailSb.append( getMsgDetail1(vos[0], "TW2", "EX_TW2", "TW_T1", "42", "4") );
			detailSb.append( getMsgDetail1(vos[0], "TP2", "EX_TP2", "TP_T1", "40", "-20") );
			detailSb.append( getMsgDetail1(vos[0], "PDMT2", "EX_D12", "PDMT_R_D1", "30", "4") );
			detailSb.append( getMsgDetail1(vos[0], "PRV2", "EX_PRV2", "PIN_PRV_M2", "70", "37") );
			detailSb.append( getMsgDetail1(vos[0], "PD2", "EX_PD2", "PD_T1", "49", "39") );
			detailSb.append( getMsgDetail1(vos[0], "OVP_X1", "EX_OVP", "OVP_X1","10", "4") );
			//detailSb.append( getMsgDetail1(vos[0], "TPO1", "EX_TPO1", "TPO_S1","205", "175") );
			//detailSb.append( getMsgDetail1(vos[0], "TPO2", "EX_TPO2", "TPO_T1","205", "175") );
			
			detailSb.append( getMsgDetail1(vos[0], "混合总管温度", "EX_MIXCAB", "MIXCAB_G1", "30", "3") );
