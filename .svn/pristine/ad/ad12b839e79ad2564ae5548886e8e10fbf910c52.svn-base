package com.sep.flex.modules.fileManager 
{
	 ...
	 * @date Aug 10, 2011
	 */
	public class JKAttachDownloadBtnListener implements ListButtonListener
	{
		...
		public function JKAttachDownloadBtnListener()
		{
		...
		private function confirmHandler(event:CloseEvent):void{
			if(event.detail == Alert.YES){
				...
				formService.riskAndKeyPointFileDownload(selectObj["ID"],selectObj["NAME"]);
			}
		}
