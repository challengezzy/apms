package com.apms.flex.modules.engine.listeners
{
	...
	public class A10TelegraphViewCFMListener implements ListButtonListener
	{  
		...
		public function A10TelegraphViewCFMListener()
		{
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			sql = "SELECT * FROM V_A10CLIST_VIEW WHERE MSG_NO='"+msgno+"'";
		...
		private function getA10ListHashVoHandler(event:ResultEvent):void{
			...
			a10cViewWindow = new A10CTelegraphViewWindow();
			a10cViewWindow.a10cvo = a10vo;
			
			PopUpManager.addPopUp(a10cViewWindow,desktop,true);
			PopUpManager.centerPopUp(a10cViewWindow);
		}
