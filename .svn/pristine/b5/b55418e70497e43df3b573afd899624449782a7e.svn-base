 ...
 * 
 */
public class WrnDataParseImpl_A330A340 {
	private Logger logger = NovaLogger.getLogger(this.getClass());
	
	private WrnDataParseImpl_A330A340(){
		
	}
	
	public static WrnDataParseImpl_A330A340 getInstance(){
		WrnDataParseImpl_A330A340 wrn = null;
		if(wrn==null){
			wrn=new WrnDataParseImpl_A330A340();
		}
		return wrn;
	}
...
//				wrnvo.setAtano_sub(atano_sub);
				wrnvo.setAtano_sub("");//A330，A340没有子章节
				
				String phase=line.substring(19,21);
				try{
				...
				String warn_content=line.substring(21,line.length());
