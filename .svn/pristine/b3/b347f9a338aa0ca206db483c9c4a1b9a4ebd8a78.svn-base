package com.sep.flex.modules.buttonListener
{
	...
	public class PrintA3PromptCardListener implements ListButtonListener
	{
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			var jobcardId:String = listData["ID"].toString();
...
//			});
//			
//			formService.getA3CardData(listData["ID"].toString());
