...
public class AcarsN1Vo_A06_A320_CFM extends AcarsLineDataVo{
	...
	public AcarsN1Vo_A06_A320_CFM(String str) throws Exception{
		originalStr = str;
		...
		psel = ReportParseUtil.getNumberStr(columns[8]);		
	}
