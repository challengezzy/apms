package com.apms.flex.modules.engine.listeners
{
	...
	public class A06TelegraphViewCFMListener implements ListButtonListener
	{  
		...
		public function A06TelegraphViewCFMListener()
		{
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			var sqlA06C:String = "SELECT * FROM V_A06CLIST_VIEW WHERE MSG_NO='"+msgno+"'";
			formService.getSimpleHashVoArrayByDS(ApmsUIConst.DATASOURCE_APMS,sqlA06C);
		...
		private function getA06ListHashVoHandler(event:ResultEvent):void{
			...
			a06cViewWindow = new A06CTelegraphViewWindow();
			//a02cViewWindow.telegraphContent = teleContent;
			a06cViewWindow.a06cvo = a06vo;
			
			PopUpManager.addPopUp(a06cViewWindow,desktop,true);
			PopUpManager.centerPopUp(a06cViewWindow);
		}
