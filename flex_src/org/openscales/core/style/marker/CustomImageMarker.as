package org.openscales.core.style.marker
{
	...
	/** zhangzy 2014-9-25 从org.openscales.core.style.marker.CustomMarker复制
	 *  直接动态指定url图片
	 * */
	public class CustomImageMarker extends Marker
	{
		 ...
		 */
		[Embed(source="/com/apms/flex/assets/feature/marker-blue.png")]
		private var _defaultImage:Class;
		
		private var _width:Number = 0;
		private var _height:Number = 0;
		
		public function CustomImageMarker(url:String = null,width:Number=0,height:Number=0,
									 opacity:Number=1,
									 xOffset:Number=0.5,
		...
		override public function getDisplayObject(feature:Feature):DisplayObject {
			...
			if (this._clip)
			{
				...
				//add by zhangzy 20140925,支持设置大小，如果长和高均不为0
