package com.apms.flex.modules.engine.listeners
{
	...
	public class A07TelegraphViewIAEListener implements ListButtonListener
	{  
		...
		public function A07TelegraphViewIAEListener()
		{
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			sql = "SELECT * FROM V_A07ILIST_VIEW WHERE MSG_NO='"+msgno+"'";
		...
		private function getA07ListHashVoHandler(event:ResultEvent):void{
			...
			a07iViewWindow = new A07ITelegraphViewWindow();
			//a02iViewWindow.telegraphContent = teleContent;
			a07iViewWindow.a07ivo = a07vo;
			
			PopUpManager.addPopUp(a07iViewWindow,desktop,true);
			PopUpManager.centerPopUp(a07iViewWindow);
		}
