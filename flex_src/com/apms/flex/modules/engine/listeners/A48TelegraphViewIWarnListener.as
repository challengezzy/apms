package com.apms.flex.modules.engine.listeners
{
	...
	import com.apms.flex.modules.engine.telegraph.A48IWarnTelegraphViewWindow;
	...
	public class A48TelegraphViewIWarnListener implements ListButtonListener
	{
		...
		private var a48iViewWindow:A48IWarnTelegraphViewWindow;

		private var teleContent:String;
		private var thedmu:String

		public function A48TelegraphViewIWarnListener()
		{
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			var sql2:String = "SELECT * FROM V_A48ILIST_WARNVIEW WHERE MSG_NO='"+msgno+"'";
		...
		private function geta48ListHashVoHandler(event:ResultEvent):void{
			...
			a48iViewWindow = new A48IWarnTelegraphViewWindow();
