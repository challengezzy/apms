package com.apms.flex.modules.engine.listeners
{
	...
	import com.apms.flex.modules.engine.telegraph.A49ITelegraphViewWindow;
	...
	public class A49TelegraphViewIAEListener implements ListButtonListener
	{
		...
		private var a49iViewWindow:A49ITelegraphViewWindow;

		private var teleContent:String;
		private var thedmu:String

		public function A49TelegraphViewIAEListener()
		{
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			var sql2:String = "SELECT * FROM V_A49ILIST_VIEW WHERE MSG_NO='"+msgno+"'";
		...
		private function getA49ListHashVoHandler(event:ResultEvent):void{
			...
			var a49Arr:Array = event.result as Array;
			var a49vo:SimpleHashVO = a49Arr[0];
			
			a49iViewWindow = new A49ITelegraphViewWindow();
			a49iViewWindow.telegraphContent = teleContent;
			a49iViewWindow.a49vo = a49vo;
			
			PopUpManager.addPopUp(a49iViewWindow,desktop,true);
			PopUpManager.centerPopUp(a49iViewWindow);
		}
