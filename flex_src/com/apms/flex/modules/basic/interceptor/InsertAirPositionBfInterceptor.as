package com.apms.flex.modules.basic.interceptor
{
	...
	public class InsertAirPositionBfInterceptor implements ClientInterceptorIFC
	{
		...
		public function handler(obj:Object):void{
			...
			var airObj:Object=cardValue["AIRPORTID"];
			cardValue["LINKCODE"]=airObj.name+cardValue["CODE"] as String;
		}	
	}
}