package com.cool.components.datagrid
{
	...
	public class DataGridUtils
	{
      	...
      	public static function loadDataGridInExcel( dataGrid:DataGrid ):void 
		{
			...
			var CSV_EXPORT_SCRIPT:String = "csvExport.php?secret=d2kL!co$2a";
			var CSV_IMPORT_SCRIPT:String = "csvImport.php?secret=d2kL!co$2a";
			
			var url:String = SERVER_URL + CSV_EXPORT_SCRIPT;
